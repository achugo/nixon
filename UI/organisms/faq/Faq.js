          ...
          <FlexItem flex={1}>
            <ContactBox>
              <Wrap>
                ...
                <h4>+1 (646) 786-5060</h4>
                <Text color={AppColors.ash}>We are happy to helps</Text>
              </Wrap>
            </ContactBox>
          </FlexItem>
          <FlexItem flex={1}>
            <ContactBox>
              <Wrap>
                ...
                <h4>support@nixonexpress.com</h4>
                <Text color={AppColors.ash}>support@nixonexpress.com</Text>
              </Wrap>
            </ContactBox>
          </FlexItem>
        </FlexWrapper>
